"""End-to-end tests for Anthropic docr."""

import pytest

from docr_mcp.core.search import SearchIndex
from docr_mcp.docrs.public.anthropic import AnthropicDocr
...
class TestAnthropicE2E:
    ...
    def test_tool_use_workflow(self):
        """Test full workflow: ask about tool use."""
        ...
        with docr:
            ...
            assert len(results) > 0, "Should find tool use docs"
