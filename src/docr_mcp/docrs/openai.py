...
class OpenAIDocr(BaseDocr):
    """Docr for OpenAI documentation (developers.openai.com)."""

    ALLOWED_DOMAINS = {"developers.openai.com", "openai.com"}
    ...
    def fetch_content(self, url: str) -> Document:
        """Fetch and parse an OpenAI documentation page.

        OpenAI URLs in llms.txt already include .md extension. This method
        ...
        return Document(
            url=url, content=content, metadata={"title": title, "source": "openai", "format": content_format}
        )
